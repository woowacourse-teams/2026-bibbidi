...
class WithdrawalServiceIntegrationTest {
    ...
    void shouldRevokeAllSessionsOnWithdrawal() {
        ...
        withdrawalService.withdraw(owner.userId(), bibbidiTokenIssuer.issueDeleteGrantToken(owner.userId()));
    ...
    void shouldRejectDeleteGrantOfOtherUser() {
        ...
        String otherGrant = bibbidiTokenIssuer.issueDeleteGrantToken(other.id());
