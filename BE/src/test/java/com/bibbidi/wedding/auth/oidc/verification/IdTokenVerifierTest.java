...
class IdTokenVerifierTest {
    ...
    void shouldVerifyIdTokenOfEachProvider(
        ...
        VerifiedOidcUser identity = idTokenVerifier.verify(provider, idToken, NONCE);

        assertThat(identity)
                .extracting(
                        VerifiedOidcUser::provider,
                        VerifiedOidcUser::providerUserId,
                        VerifiedOidcUser::nickname,
                        VerifiedOidcUser::email)
