...
public class ChecklistController {
    ...
    public Long create(@AuthenticationPrincipal(expression = "userId") Long userId) {
        ChecklistCreationResult result = checklistService.create(userId);
        return result.id();
    }

    @GetMapping("/api/checklists/me")
    public ChecklistWithAppointmentsResponse findMyChecklist(@AuthenticationPrincipal(expression = "userId") Long userId) {
    ...
    public ChecklistProgressResponse findMyChecklistProgress(@AuthenticationPrincipal(expression = "userId") Long userId) {
    ...
    public List<RecommendedCatalogItemResponse> findRecommendedCatalogItems(@AuthenticationPrincipal(expression = "userId") Long userId, @RequestParam(defaultValue = "4") @Min(1) @Max(20) int limit) {
    ...
    public ChecklistItemResponse addCustomItem(@AuthenticationPrincipal(expression = "userId") Long userId,
